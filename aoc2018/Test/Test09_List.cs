...
namespace aoc2018.Test
{
    public class Test09_List
    {
        ...
        public Test09_List(ITestOutputHelper output)
        {
            _output = output;
        }
        ...
        {
            var result = Day09_List.Solve(players, lastMarble);
        ...
        public void Solve1()
        {
            var result = Day09_List.Solve(400, 71864);
        ...
        public void Solve2()
        {
            var result = Day09_List.Solve(400, 7186400);
            _output.WriteLine(result.ToString());
        }
    }
}
